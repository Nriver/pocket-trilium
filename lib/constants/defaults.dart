...
class D {
  ...
  static const List<Map<String, dynamic>> triliumVersions = [
    ...
    },
    {
      'name': '0.104.1',
      'suffix': '(Gitee)',
      'url': 'https://gitee.com/nriver/pocket-trilium/releases/download/v1/TriliumNotes-Server-v0.104.1-linux-arm64.tar.xz',
      'lang': 'multi',
    },
    {
      'name': '0.104.0',
      'suffix': '(GitHub)',
      'url': 'https://github.com/TriliumNext/Trilium/releases/download/v0.104.0/TriliumNotes-Server-v0.104.0-linux-arm64.tar.xz',
      'lang': 'multi',
    },
    {
      'name': '0.104.0',
      'suffix': '(Gitee)',
      'url': 'https://gitee.com/nriver/pocket-trilium/releases/download/v1/TriliumNotes-Server-v0.104.0-linux-arm64.tar.xz',
      'lang': 'multi',
    },
    {
      'name': '0.103.0',
      'suffix': '(GitHub)',
      'url': 'https://github.com/TriliumNext/Trilium/releases/download/v0.103.0/TriliumNotes-Server-v0.103.0-linux-arm64.tar.xz',
      'lang': 'multi',
    },
    {
      'name': '0.103.0',
      'suffix': '(Gitee)',
      'url': 'https://gitee.com/nriver/pocket-trilium/releases/download/v1/TriliumNotes-Server-v0.103.0-linux-arm64.tar.xz',
      'lang': 'multi',
    },
    {
      'name': '0.102.2',
